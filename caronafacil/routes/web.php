...
Route::prefix('passageiro')->group(function () {
    ...
    Route::get('/passageiros/{id}/edit', [PassageiroAuthController::class, 'showUpdateForm'])->name('passageiros.edit');
    Route::put('/passageiros/{id}', [PassageiroAuthController::class, 'update'])->name('passageiro.update');
    Route::delete('/passageiros/{id}', [PassageiroAuthController::class, 'destroy'])->name('passageiros.destroy');
